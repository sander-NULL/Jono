...
void visualize(bitboard board) { /* Only to visualize bitboards, no real need for this function */
	int i, j;
	char visboard[8][8];
...
int vispos(chessposition pos) { /* Visualize position, also no real need for this function */
